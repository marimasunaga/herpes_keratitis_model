...
def uv_simulation(alpha, beta, gamma, delta, dv, seed):
    """
...
seed_values = list(range(10)) #Random seeds for reproducibility
...
for gamma in gamma_values:
    for seed in seed_values:
        ...
        # Run simulation
        u, v, t = uv_simulation(alpha, beta, gamma, delta, dv, seed)
