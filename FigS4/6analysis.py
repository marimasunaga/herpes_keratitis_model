...
# Statistics for filtering in 6analysis.py (root >= 20 condition)
analysis_filter_stats = {}
...
for path in csv_paths:
    ...
    # Count branches before and after root >= 20 filter
    before_root_filter = 0
    after_root_filter = 0
    ...
    for _, row in df.iterrows():
        ...
        # Count before root filter
        before_root_filter += 1

        # Count after root filter
        after_root_filter += 1
    ...
    analysis_filter_stats[model_name] = {
        'before_root_filter': before_root_filter,
        'after_root_filter': after_root_filter
    }
