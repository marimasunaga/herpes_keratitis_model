...
beta_values = np.arange(0.6, 1.41, 0.2) #Infection inhibition coefficient (cytokine-dependent; e.g., cellular sensitivity to cytokines)
gamma = 1.0 #Cytokine secretion rate
...
output_dir = os.path.join(script_dir, "beta")
