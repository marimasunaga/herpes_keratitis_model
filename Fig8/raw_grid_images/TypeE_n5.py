...
gamma_values = [0.8, 0.9, 1.0] #Cytokine secretion rate
delta = 0.5 #Cytokine degradation rate
n = 5 #The number of layers producing cytokine
...
output_dir = os.path.join(script_dir, "n5")
...
for gamma in gamma_values:
    ...
    filename = os.path.join(
        ...
        f"d{delta:.3f}_Dv{dv:.3f}_n{n}_iter{t}.png"
    )
    plt.imsave(
        filename,
        u,
