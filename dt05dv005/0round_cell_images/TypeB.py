...
dt = 0.5                                # Time step, \approx 0.5$ hours; estimated from visual similarity to ex vivo lesion data
...
gamma_values = np.arange(0.5, 6.501, 0.5) #Cytokine secretion rate
...
output_dir = os.path.join(script_dir, "TypeB")
